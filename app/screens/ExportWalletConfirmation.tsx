...
function ExportWalletConfirmation() {
  ...
  const exportWallet = async (seed: string) => {
    ...
    try {
      ...
      const zipUpDirectory = `${downloadDirectory}/Medera-Wallet-${backupTimeStamp}`
      ...
      const WALLET_FILE_NAME = 'Medera_WALLET'
