...
const translation = {
  ...
  "Tour": {
    "GuideTitle": "Welcome to Medera Wallet",
    "WouldYouLike": "Would you like some guidance on how to use Medera Wallet?",
  ...
  "Terms": {
    ...
    "IAgree": "I Agree",
    "Attestation": "I have read, understood and accept the terms and conditions.",
  },
  "CameraDisclosure": {
    ...
    "ToContinueUsing": "To continue using the Medera Wallet scan feature, please allow camera permissions in the settings.",
    "Continue": "Continue",
  ...
  "Biometry": {
    ...
    "EnabledText1Bold": "you will need to use biometrics to open your Medera Wallet.",
    "EnabledText2": "Because of this, your Medera wallet may be accessed using any fingerprint or face data you upload to this phone. Make sure you are the only one who can access your wallet.",
    "EnabledText3": "Anyone who can access your phone with biometrics can access your Medera Wallet.",
  ...
  "Settings": {
    ...
    "HelpUsingBCWallet": "Help using Medera Wallet",
  ...
  "Tips": {
    ...
    "Tip1": "For extra security, Medera Wallet locks the app after 5 minutes of inactivity",
  ...
  "NetInfo": {
    ...
    "NoInternetConnectionMessage": "You're unable to access services using Medera or receive credentials until you're back online.\n\nPlease check your internet connection.",
  ...
  "Onboarding": {
    "SkipA11y": "Skip introduction to Medera",
  },
  "Chat": {
